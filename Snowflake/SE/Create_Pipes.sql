...
--select LISTAGG(CONCAT('DROP PIPE ',pipe_name),';') from "SOURCE_SYSTEM_TEST"."INFORMATION_SCHEMA"."PIPES";
...
AS
COPY INTO  SOURCE_SYSTEM_TEST.SAPRAW."CSKS"FROM 
( 
...
FROM 
    @SE_DATALAKE_STAGE/EDU/IO/ATTR/
  
) ;
 
--LIST @SE_DATALAKE_STAGE/EDU/IO/ATTR

CREATE OR REPLACE PIPE "SNOWPIPE_0COSTELMNT_0102_HIER_INTVL"
  ----auto_ingest = true
  --integration = 'SNOWPIPE_NOTIFICATION' 
AS
COPY INTO  SOURCE_SYSTEM_TEST.SAPRAW."0COSTELMNT_0102_HIER_INTVL"FROM 
( 
...
CREATE OR REPLACE PIPE "SNOWPIPE_0PROFIT_CTR_TEXT"
  ...
  --integration = 'SNOWPIPE_NOTIFICATION' 
AS
COPY INTO  SOURCE_SYSTEM_TEST.SAPRAW."0PROFIT_CTR_TEXT"FROM 
( 
...
CREATE OR REPLACE PIPE "SNOWPIPE_ZDIVISION"
  ...
  --integration = 'SNOWPIPE_NOTIFICATION' 
AS
COPY INTO  SOURCE_SYSTEM_TEST.SAPRAW."ZDIVISION"FROM 
( 
...
CREATE OR REPLACE PIPE "SNOWPIPE_0VENDOR_TEXT"
  ...
  --integration = 'SNOWPIPE_NOTIFICATION' 
AS
COPY INTO  SOURCE_SYSTEM_TEST.SAPRAW."0VENDOR_TEXT"FROM 
( 
...
CREATE OR REPLACE PIPE "SNOWPIPE_0CURTYPE_TEXT"
  ...
  --integration = 'SNOWPIPE_NOTIFICATION' 
AS
COPY INTO  SOURCE_SYSTEM_TEST.SAPRAW."0CURTYPE_TEXT"FROM 
( 
SELECT $1:LANGU::VARCHAR(2) AS LANGU 
...
CREATE OR REPLACE PIPE "SNOWPIPE_0COMP_CODE_TEXT"
  ...
  --integration = 'SNOWPIPE_NOTIFICATION' 
AS
COPY INTO  SOURCE_SYSTEM_TEST.SAPRAW."0COMP_CODE_TEXT"FROM 
( 
...
CREATE OR REPLACE PIPE "SNOWPIPE_CSKT"
  ...
  --integration = 'SNOWPIPE_NOTIFICATION' 
AS
COPY INTO  SOURCE_SYSTEM_TEST.SAPRAW."CSKT"FROM 
( 
SELECT $1:MANDT::VARCHAR(3) AS MANDT 
,$1:SPRAS::VARCHAR(1) AS SPRAS 
,$1:KOKRS::VARCHAR(4) AS KOKRS 
...
CREATE OR REPLACE PIPE "SNOWPIPE_0VENDOR_ATTR"
  ...
  --integration = 'SNOWPIPE_NOTIFICATION' 
AS
COPY INTO  SOURCE_SYSTEM_TEST.SAPRAW."0VENDOR_ATTR"FROM 
( 
SELECT $1:LIFNR::VARCHAR(10) AS LIFNR 
,$1:ANRED::VARCHAR(15) AS ANRED 
...
CREATE OR REPLACE PIPE "SNOWPIPE_0COSTELMNT_0102_HIER"
  ...
  --integration = 'SNOWPIPE_NOTIFICATION' 
AS
COPY INTO  SOURCE_SYSTEM_TEST.SAPRAW."0COSTELMNT_0102_HIER"FROM 
( 
...
CREATE OR REPLACE PIPE "SNOWPIPE_0CO_OM_CCA_1"
  ...
  --integration = 'SNOWPIPE_NOTIFICATION' 
AS
COPY INTO  SOURCE_SYSTEM_TEST.SAPRAW."0CO_OM_CCA_1"FROM 
( 
...
,current_timestamp::timestamp_ntz
FROM 
    @SE_DATALAKE_STAGE/EDU/CO/CO-OM/CO-OM-CCA/  
) ;
...
CREATE OR REPLACE PIPE "SNOWPIPE_0COSTCENTER_0101_HIER"
  ...
  --integration = 'SNOWPIPE_NOTIFICATION' 
AS
COPY INTO  SOURCE_SYSTEM_TEST.SAPRAW."0COSTCENTER_0101_HIER"FROM 
( 
SELECT $1:NODEID::VARCHAR(8) AS NODEID 
,$1:IOBJNM::VARCHAR(30) AS IOBJNM 
,$1:NODENAME::VARCHAR(32) AS NODENAME 
...
CREATE OR REPLACE PIPE "SNOWPIPE_0PROFIT_CTR_ATTR"
  ...
  --integration = 'SNOWPIPE_NOTIFICATION' 
AS
COPY INTO  SOURCE_SYSTEM_TEST.SAPRAW."0PROFIT_CTR_ATTR"FROM 
( 
...
CREATE OR REPLACE PIPE "SNOWPIPE_0COSTELMNT_ATTR"
  ...
  --integration = 'SNOWPIPE_NOTIFICATION' 
AS
COPY INTO  SOURCE_SYSTEM_TEST.SAPRAW."0COSTELMNT_ATTR"FROM 
( 
SELECT $1:KOKRS::VARCHAR(4) AS KOKRS 
,$1:KSTAR::VARCHAR(10) AS KSTAR 
,TO_DATE(TO_TIMESTAMP($1:DATETO)) AS DATETO 
...
CREATE OR REPLACE PIPE "SNOWPIPE_0CO_OM_CCA_9"
  ...
  --integration = 'SNOWPIPE_NOTIFICATION' 
AS
COPY INTO  SOURCE_SYSTEM_TEST.SAPRAW."0CO_OM_CCA_9"FROM 
( 
SELECT $1:KOKRS::VARCHAR(4) AS KOKRS 
...
CREATE OR REPLACE PIPE "SNOWPIPE_0COSTELMNT_TEXT"
  ...
  --integration = 'SNOWPIPE_NOTIFICATION' 
AS
COPY INTO  SOURCE_SYSTEM_TEST.SAPRAW."0COSTELMNT_TEXT"FROM 
( 
SELECT $1:LANGU::VARCHAR(2) AS LANGU 
,$1:KOKRS::VARCHAR(4) AS KOKRS 
,$1:KSTAR::VARCHAR(10) AS KSTAR 
...
CREATE OR REPLACE PIPE "SNOWPIPE_0VTYPE_TEXT"
  ...
  --integration = 'SNOWPIPE_NOTIFICATION' 
AS
COPY INTO  SOURCE_SYSTEM_TEST.SAPRAW."0VTYPE_TEXT"FROM 
( 
SELECT $1:LANGU::VARCHAR(2) AS LANGU 
