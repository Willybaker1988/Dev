...
CREATE OR REPLACE VIEW vw_DIM_COST_ELEMENT AS
...
CREATE OR REPLACE VIEW VW_DIM_VENDOR AS
SELECT
    A.*,
    B.TXTMD
FROM
    SOURCE_SYSTEM_TEST.SAPRAW."0VENDOR_ATTR" A
LEFT JOIN
    SOURCE_SYSTEM_TEST.SAPRAW."0VENDOR_TEXT" B ON A.LIFNR = B.LIFNR
;


CREATE OR REPLACE VIEW VW_DIM_CURRENCY_TYPE AS 
SELECT
    *
FROM
   SOURCE_SYSTEM_TEST.SAPRAW."0CURTYPE_TEXT" 
WHERE
    LANGU = 'E';
   

CREATE OR REPLACE VIEW VW_DIM_VALUE_TYPE AS 
SELECT
    *
FROM
   SOURCE_SYSTEM_TEST.SAPRAW."0VTYPE_TEXT" ;
   

CREATE OR REPLACE VIEW VW_DIM_DIVISION AS 
SELECT
    *
FROM
   SOURCE_SYSTEM_TEST.SAPRAW."ZDIVISION" ;
   
   
CREATE OR REPLACE VIEW VW_DIM_MILL AS 
SELECT
    *
FROM
    SOURCE_SYSTEM_TEST.PUBLIC."MILL" ;
